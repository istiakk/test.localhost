...
* Site name
*/
$cfg['site']['name'] = "Istiak MVC Framework";
/**
* Site owner name
*/
$cfg['site']['owner'] = "Istiak Mah";
/**
* Page title
*/
...
* site address
*/
$cfg['site']['address'] = 'https://github.com/istiakk';
/**
* company logo
*/
$cfg['site']['logo'] = 'ist.png';
/**
...
*/
$cfg['site']['contacts'] = array('Istiak Mah <istiak.mahmood@gmail.com>');
/**
* System email sender address
*/
$cfg['site']['email_sender'] = 'WebMaster <istiak.mahmood@gmail.com>';
...
*/
$cfg['php']['date.timezone'] = 'Europe/Stockholm'; 
/**
* Mail function 
*/
